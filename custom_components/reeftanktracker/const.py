...
SERVICE_UPDATE_SUPPLEMENT_PROFILE = "update_supplement_profile"
...
SERVICE_SUBMIT_ICP_FORM = "submit_icp_import_form"
...
EVENT_CALIBRATION_RECORDED = f"{DOMAIN}_calibration_recorded"
